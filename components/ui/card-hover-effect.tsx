    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <Card>
            <CardTitle className="text-violet-700">{item.title}</CardTitle>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-zinc-900 border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}
    >
